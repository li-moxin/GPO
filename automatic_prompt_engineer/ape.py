...
def find_prompts_naive(eval_template,
                 demos_template,
                 prompt_gen_data,
                 eval_data,
                 conf,
    ...
    # Generate prompts
    eval_template = template.EvalTemplate(eval_template)
    demos_template_for_gen = template.DemosTemplate2(demos_template)
    demos_template = template.DemosTemplate(demos_template)
    ...
    prompts = generate.generate_prompts_naive(
        prompt_gen_template, demos_template_for_gen, prompt_gen_data, conf['generation'])
